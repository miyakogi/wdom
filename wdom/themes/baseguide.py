...
Col = NewTag('Col', 'div', Div, class_='col')
Col1 = NewTag('Col', 'div', Col, class_='col-xs-1 col-sm-1 col-md-1 col-lg-1')
Col2 = NewTag('Col', 'div', Col, class_='col-xs-2 col-sm-2 col-md-2 col-lg-2')
Col3 = NewTag('Col', 'div', Col, class_='col-xs-3 col-sm-3 col-md-3 col-lg-3')
Col4 = NewTag('Col', 'div', Col, class_='col-xs-4 col-sm-4 col-md-4 col-lg-4')
Col5 = NewTag('Col', 'div', Col, class_='col-xs-5 col-sm-5 col-md-5 col-lg-5')
Col6 = NewTag('Col', 'div', Col, class_='col-xs-6 col-sm-6 col-md-6 col-lg-6')
Col7 = NewTag('Col', 'div', Col, class_='col-xs-7 col-sm-7 col-md-7 col-lg-7')
Col8 = NewTag('Col', 'div', Col, class_='col-xs-8 col-sm-8 col-md-8 col-lg-8')
Col9 = NewTag('Col', 'div', Col, class_='col-xs-9 col-sm-9 col-md-9 col-lg-9')
Col10 = NewTag('Col', 'div', Col, class_='col-xs-10 col-sm-10 col-md-10 col-lg-10')
Col11 = NewTag('Col', 'div', Col, class_='col-xs-11 col-sm-11 col-md-11 col-lg-11')

...
Col1 = NewTag('Col1', 'div', Col1, class_='mdl-cell--1-col')
Col2 = NewTag('Col2', 'div', Col2, class_='mdl-cell--2-col')
Col3 = NewTag('Col3', 'div', Col3, class_='mdl-cell--3-col')
Col4 = NewTag('Col4', 'div', Col4, class_='mdl-cell--4-col')
Col5 = NewTag('Col5', 'div', Col5, class_='mdl-cell--5-col')
Col6 = NewTag('Col6', 'div', Col6, class_='mdl-cell--6-col')
Col7 = NewTag('Col7', 'div', Col7, class_='mdl-cell--7-col')
Col8 = NewTag('Col8', 'div', Col8, class_='mdl-cell--8-col')
Col9 = NewTag('Col9', 'div', Col9, class_='mdl-cell--9-col')
Col10 = NewTag('Col10', 'div', Col10, class_='mdl-cell--10-col')

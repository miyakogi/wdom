...
Col1 = NewTag('Col1', 'div', Col, class_='mui-col-xs-1 mui-col-sm-1 mui-col-md-1 mui-col-lg-1')
Col2 = NewTag('Col2', 'div', Col, class_='mui-col-xs-2 mui-col-sm-2 mui-col-md-2 mui-col-lg-2')
Col3 = NewTag('Col3', 'div', Col, class_='mui-col-xs-3 mui-col-sm-3 mui-col-md-3 mui-col-lg-3')
Col4 = NewTag('Col4', 'div', Col, class_='mui-col-xs-4 mui-col-sm-4 mui-col-md-4 mui-col-lg-4')
Col5 = NewTag('Col5', 'div', Col, class_='mui-col-xs-5 mui-col-sm-5 mui-col-md-5 mui-col-lg-5')
Col6 = NewTag('Col6', 'div', Col, class_='mui-col-xs-6 mui-col-sm-6 mui-col-md-6 mui-col-lg-6')
Col7 = NewTag('Col7', 'div', Col, class_='mui-col-xs-7 mui-col-sm-7 mui-col-md-7 mui-col-lg-7')
Col8 = NewTag('Col8', 'div', Col, class_='mui-col-xs-8 mui-col-sm-8 mui-col-md-8 mui-col-lg-8')
Col9 = NewTag('Col9', 'div', Col, class_='mui-col-xs-9 mui-col-sm-9 mui-col-md-9 mui-col-lg-9')
Col10 = NewTag('Col10', 'div', Col, class_='mui-col-xs-10 mui-col-sm-10 mui-col-md-10 mui-col-lg-10')
Col11 = NewTag('Col11', 'div', Col, class_='mui-col-xs-11 mui-col-sm-11 mui-col-md-11 mui-col-lg-11')

...
class WebElementTestCase(ElementTestCase):
    ...
    def test_text_content(self):
        ...
        self.wait()
        self.assertEqual(self.browser.get_text(), 'text')

        self.c1.textContent = 'child'
        self.tag.appendChild(self.c1)
        self.wait()
        self.assertEqual(self.browser.get_text(), 'textchild')

        self.tag.textContent = 'NewText'
        self.wait()
        self.assertEqual(self.browser.get_text(), 'NewText')
        ...
        self.wait()
        self.assertEqual(self.browser.get_text(), 'TextNode')
    ...
    def test_insert_child(self):
        ...
        self.set_element(self.tag)
        self.assertEqual(self.browser.get_text(), 'child2child1')
    ...
    def test_add_df(self):
        ...
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child1child2text')

        df = DocumentFragment()
        df.append(self.c3, 'text2')
        self.tag.appendChild(df)
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child1child2textchild3text2')
    ...
    def test_insert_df(self):
        ...
        self.wait(0.1)
        self.assertEqual(self.browser.get_text(), 'child2child3textchild1')

        df = DocumentFragment()
        df.append(self.c4, 'text2')
        self.tag.insertBefore(df, self.c3)
        self.wait(0.1)
        self.assertEqual(self.browser.get_text(), 'child2child4text2child3textchild1')
    ...
    def test_append(self):
        ...
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child1child2child3')

        self.tag.append(self.c4, self.c1)
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child2child3child4child1')

        self.tag.append('t1', 't2')
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child2child3child4child1t1t2')
    ...
    def test_prepend(self):
        ...
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child2child3child1')

        self.tag.prepend(self.c4, self.c1)
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child4child1child2child3')

        self.tag.prepend('t1', 't2')
        self.wait()
        self.assertEqual(self.browser.get_text(), 't1t2child4child1child2child3')

    def test_prepend_append_text(self):
        self.set_element(self.tag)
        self.tag.append('t1')
        self.wait()
        self.assertEqual(self.browser.get_text(), 't1')
        ...
        self.tag.prepend('t2')
        self.wait()
        self.assertEqual(self.browser.get_text(), 't2')

        self.tag.append('t3', 't4')
        self.wait()
        self.assertEqual(self.browser.get_text(), 't2t3t4')

        self.tag.prepend('t5', 't6')
        self.wait()
        self.assertEqual(self.browser.get_text(), 't5t6t2t3t4')
    ...
    def test_after(self):
        ...
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child1child2')

        self.c1.after(self.c3, self.c4)
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child1child3child4child2')

        self.c1.after(self.c2, 'text')
        self.wait()
        self.assertEqual(self.browser.get_text(), 'child1child2textchild3child4')
    ...
    def test_before(self):
        ...
        self.wait(0.1)
        self.assertEqual(self.browser.get_text(), 'child3child4child2textchild1')
    ...
    def test_after_before_text(self):
        ...
        t.after('b')
        self.wait()
        self.assertEqual(self.browser.get_text(), 'ab')

        t.after('c', 'd')
        self.wait()
        self.assertEqual(self.browser.get_text(), 'acdb')

        t.before('e')
        self.wait(0.1)
        self.assertEqual(self.browser.get_text(), 'eacdb')

        t.before('f', 'g')
        self.wait(0.1)
        self.assertEqual(self.browser.get_text(), 'efgacdb')
    ...
    def test_style(self):
        ...
        self.wait()
        self.set_element(self.tag)
        self.assertEqual(self.browser.get_attribute('style'), '')
        style = 'color: red;'
        self.tag.style = style
        self.wait()
        self.assertEqual(self.browser.get_attribute('style'), style)
        self.tag.style.color = 'black'
        self.wait()
        self.assertEqual(self.browser.get_attribute('style'), 'color: black;')
    ...
    def test_classlist(self):
        ...
        self.wait()
        self.assertEqual(self.browser.get_attribute('class'), 'a b c d')

        self.tag.classList.remove('c')
        self.wait()
        self.assertEqual(self.browser.get_attribute('class'), 'a b d')
        self.tag.classList.remove('a', 'd')
        self.wait()
        self.assertEqual(self.browser.get_attribute('class'), 'b')
